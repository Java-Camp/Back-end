...
import com.jcf.orm.storages.DataTypes;
...
public final class SQLBuilder {
    ...
    public static String buildCreateForeignKeyRequest(Entity entity, Field field) {
        ...
        StringBuilder SQLRequest = new StringBuilder();
        try {
            String name = "persistence.model." + annotation.entity();
            ...
            SQLRequest.append("(").append(field.getAnnotation(Column.class).name()).append(")");
