...
public class EntityDAO implements AutoCloseable {
    ...
    public ResultSet getEntityResultSet(Entity entity) throws SQLException {
        ...
        final Statement statement = OracleConnectionPool.getInstance().getConnection().createStatement();
    ...
    public Set<Object> getMappedObjectList(Entity entity, Entity mappedEntity, Field manyToOneField){
        ...
        Entity localEntity;
        try (final Statement statement = OracleConnectionPool.getInstance().getConnection().createStatement();
    ...
    public void updateRecordInTable(Entity entity) {
        ...
        try (final PreparedStatement statement = OracleConnectionPool.getInstance().getConnection()
